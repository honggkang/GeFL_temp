...
dataloader = DataLoader(DatasetSplit(dataset_train, dict_users[0]), batch_size=args.local_bs, shuffle=True)
...
torch.save(w_comm, 'models/save/' + str(args.partial_data) + '_'
            + str(args.n_epochs) + 'CNN_common_net.pt')