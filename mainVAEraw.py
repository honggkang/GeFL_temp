...
parser.add_argument('--noniid', action='store_true') # store_true default: false
...
parser.add_argument('--wu_epochs', type=int, default=200) # warm-up epochs
...
def main():
    ...
    for iter in range(1, args.wu_epochs+1):
        ...
        for idx in idxs_users:
            ...
            local = LocalUpdate_VAE_raw(args, dataset=dataset_train, idxs=dict_users[idx])
    ...
    for iter in range(1,args.epochs+1):
        ...
        for idx in idxs_users:
            ...
            local_gen = LocalUpdate_VAE_raw(args, dataset=dataset_train, idxs=dict_users[idx])
    ...
    save_image(sample.view(sample_num, 1, args.feature_size, args.feature_size), 
                'imgFedCVAE/' + 'sample_raw' + '.png', nrow=10)
