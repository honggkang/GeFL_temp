...
parser.add_argument("--gen_n_epochs", type=int, default=0, help="number of epochs of training by samples generated by generator")
...
parser.add_argument('--gen', type=str, default='vae') # gan, vae, ddpm
