...
args.img_shape = (1, 14, 14)

dataset_train, dataset_test = getDataset(args)
args.latent_dim = 100
args.feature_size = 14 # 16
...
def main():
    ...
    if args.wandb:
        run = wandb.init(dir=filename, project='GeFL-fmnist-0906', name= str(args.name)+ str(args.rs), reinit=True, settings=wandb.Settings(code_dir="."))
    ...
    for iter in range(1, args.gen_wu_epochs+1):
        ...
        for idx in idxs_users:
            ...
            local = LocalUpdate_GAN(args, common_net, dataset=dataset_train, idxs=dict_users[idx])
    ...
    for iter in range(1, args.epochs+1):
        ...
        for idx in idxs_users:
            ...
            local_gen = LocalUpdate_GAN(args, common_net, dataset=dataset_train, idxs=dict_users[idx])
