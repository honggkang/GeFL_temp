...
parser.add_argument("--n_fepochs", type=int, default=10, help="number of epochs of training")
...
dict_users = dict_iid(dataset_train, 10)
...
epoch_loss = []
for iter in range(args.n_epochs): # train by samples generated by generator
    net.train()
    batch_loss = []
