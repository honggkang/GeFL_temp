...
os.makedirs("imgs/RAWimgFedVAE", exist_ok=True)
        ...
        for i, (data, labels) in enumerate(test_loader):
            ...
            if i == 0:
                ...
                save_image(comparison.cpu(),
                         'imgs/RAWimgFedVAE/' + 'recon' + str(opt.num_users) + '_' + str(epoch) + '.png', nrow=n)
    ...
    if epoch % opt.sample_interval == 0 or epoch == opt.n_epochs:
        ...
        with torch.no_grad():
            ...
            save_image(sample.view(n_row**2, 1, 28, 28),
                    'imgs/RAWimgFedVAE/' + str(opt.num_users) +'_' + str(epoch) + '.png', nrow=n_row, normalize=True)
