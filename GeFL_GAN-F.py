...
def main():
    ...
    if args.wandb:
        run = wandb.init(dir=filename, project='GeFL-GAN-1010', name= str(args.name)+ str(args.rs), reinit=True, settings=wandb.Settings(code_dir="."))
        ...
        for idx in idxs_users:
            ...
            if args.freeze_FE:
                if args.only_gen:
                    ...
                    # header update by syn+real data
                    if args.aid_by_gen:
