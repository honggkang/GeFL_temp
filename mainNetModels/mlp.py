...
class MLP2(torch.nn.Module):
    def __init__(self):
        ...
        self.fc1 = torch.nn.Linear(784, 196)
...
class MLP3(torch.nn.Module):
    def __init__(self):
        ...
        self.fc1 = torch.nn.Linear(784, 196)
        self.fc2 = torch.nn.Linear(196, 196)
        self.fc5 = torch.nn.Linear(196, 10)
...
class MLP3b(torch.nn.Module):
    def __init__(self):
        ...
        self.fc1 = torch.nn.Linear(784, 196)
        self.fc2 = torch.nn.Linear(196, 128)
...
class MLP4(torch.nn.Module):
    def __init__(self):
        ...
        self.fc1 = torch.nn.Linear(784, 196)
        self.fc2 = torch.nn.Linear(196, 256)
...
class MLP4b(torch.nn.Module):
    def __init__(self):
        ...
        self.fc1 = torch.nn.Linear(784, 196)
        self.fc2 = torch.nn.Linear(196, 400)
...
class MLP5b(torch.nn.Module):
    def __init__(self):
        ...
        self.fc1 = torch.nn.Linear(784, 196)
        self.fc2 = torch.nn.Linear(196, 320)
...
class MLP6(torch.nn.Module):
    def __init__(self):
        ...
        self.fc1 = torch.nn.Linear(784, 196) # 28*28
        self.fc2 = torch.nn.Linear(196, 256) # 16*16
        # self.fc3 = torch.nn.Linear(256, 256)
        self.fc4 = torch.nn.Linear(256, 196)
